    ...
    items: [
      {
        ...
        technologies: ['React Native', 'Flutter', 'TypeScript', 'Expo', 'Dart','iOS', 'Android', 'IA', 'Firebase', 'REST API', 'tRPC', 'CI/CD', 'Metodologías ágiles', 'Figma', 'ClickUp', 'Notion', 'Pixel-Perfect', 'Motion Design', 'MVVM', 'Clean Architecture', 'Spec-driven development', 'Feature-sliced design', 'Feature-first development'],
      },
      {
        period: '2022',
