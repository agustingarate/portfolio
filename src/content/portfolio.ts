...
export const portfolioContent = {
  ...
  hero: {
    ...
    description:
      'Especializado en experiencias móviles nativas y ecosistemas impulsados por IA, puenteando la brecha entre la ingeniería robusta y el diseño intuitivo. Mi enfoque es crear soluciones que se sientan naturales y funcionen a escala.',
  ...
  about: {
    ...
    description:
      'Con más de 5 años de experiencia diseñando e implementando arquitecturas limpias, me centro en entender el core del negocio para transformar ideas complejas en interfaces simples y flujos de trabajo eficientes.',
  },
  experience: {
  ...
  services: {
    title: 'Servicios',
    description:
      'Cada solución se define a partir del problema, las prioridades y el contexto real del producto.',
    items: [
      {
    ...
    phases: [
      {
        ...
        title: 'Discovery',
        description:
          'Investigación profunda de necesidades y definición de objetivos.',
        startWeek: 0,
        duration: 1.45,
        tone: 'blue',
      },
      {
        ...
        title: 'Kick-off',
        description:
          'Alineación inicial del equipo y establecimiento de hitos.',
        startWeek: 0.75,
        duration: 1.4,
        tone: 'coral',
      },
      ...
      },
      {
        id: 'testing',
        title: 'Testing & QA',
        description: 'Pruebas exhaustivas para asegurar la máxima calidad.',
        startWeek: 5.1,
        duration: 1.45,
        tone: 'blue',
      },
      ...
      },
      {
        id: 'training',
        title: 'Capacitación',
        description: 'Entrega final y formación para el uso del producto.',
        startWeek: 6.75,
        duration: 1.2,
        tone: 'lilac',
      },
  ...
  stack: {
    ...
    categories: [
      ...
      },
      {
        title: 'Producto & IA',
        icon: 'sparkles',
        technologies: ['Figma', 'OpenAI', 'LangChain'],
        tone: 'lilac',
      },
    ] satisfies readonly StackCategory[],
    marquee: [
      { label: 'Flutter', icon: 'mobile' },
      { label: 'React Native', icon: 'mobile' },
      { label: 'Expo', icon: 'mobile' },
      { label: 'Swift', icon: 'code' },
      { label: 'Figma', icon: 'sparkles' },
      { label: 'Node.js', icon: 'backend' },
      { label: 'Python', icon: 'code' },
      { label: 'Tailwind CSS', icon: 'frontend' },
  ...
  contact: {
    ...
    description:
      'Cuéntame sobre tu idea o desafío. Siempre estoy abierto a discutir nuevos proyectos y oportunidades.',
  ...
  footer: {
    copyright:
      'Software Developer Portfolio. Product Thinking & Mobile Expert.',
  },
} as const;
